...
\begin{itemize}
  ...
  \item \textbf{Repeat} until the goal is reached
\end{itemize}
...
\begin{itemize}
  ...
  \item Enables parallelism and role separation, cost optimization
  \item Overhead: coordination, communication, complexity
\end{itemize}
\end{block}
\end{column}
